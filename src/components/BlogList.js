...
const BlogList = () => {
  ...
  /**
   * Handle the deletion of a blog by ID.
   *
   * @param {string} id - The ID of the blog to delete
   * @return {Promise<void>} Promise that resolves after deleting the blog
   */
  ...
  /**
   * Navigates to the blog page for a specific blog post.
   *
   * @param {string} id - The ID of the blog post to open
   * @return {void} This function does not return anything
   */
  ...
  /**
   * Handles the creation of a new blog by setting the `isCreating` state to true and navigating to the '/create-blog' page.
   *
   * @return {void} This function does not return anything.
   */
  ...
  /**
   * Renders a skeleton UI for loading state.
   *
   * @return {void} This function does not return anything.
   */
        ...
        <div className="border p-6 rounded flex flex-col bg-white shadow relative transition-transform transform hover:scale-105 hover:shadow-lg">
          ...
          <div className='flex justify-center'>
            <button
              ...
              disabled={isCreating}
              className="bg-gray-100 text-black px-4 py-2 rounded-full border-2 hover:border-purple-500 hover:bg-custom-purple hover:text-white transition duration-300 flex items-center"
            >
              {isCreating ? (
